...
#define CATDayLabelWidth KSCREEN_WIDTH/7
...
- (void)setup
{
    ...
    //月份
    UILabel *masterLabel = [[UILabel alloc] initWithFrame:CGRectMake(10.f, 10.0f, KSCREEN_WIDTH - 20, 30.f)];
    ...
    self.masterLabel.textColor = KHEXRGB(0x44C08C);
    ...
    self.day2OfTheWeekLabel.textColor = KHEXRGB(0x333333);
    ...
    self.day3OfTheWeekLabel.textColor = KHEXRGB(0x333333);
    ...
    self.day4OfTheWeekLabel.textColor = KHEXRGB(0x333333);
    ...
    self.day5OfTheWeekLabel.textColor = KHEXRGB(0x333333);
    ...
    self.day6OfTheWeekLabel.textColor = KHEXRGB(0x333333);
