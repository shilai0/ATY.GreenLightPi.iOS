 ...
 */
- (instancetype)initDatePackerWithStartHour:(NSString *)startHour endHour:(NSString *)endHour selectedHour:(NSString *)selectHour selectedMin:(NSString *)selectMin period:(NSInteger)period response:(void (^)(NSString *))block{
    if (self = [super init]) {
...
- (void)initAppreaence {
    ...
    [pickerView selectRow:[hourArray indexOfObject:selectedHour] inComponent:0 animated:YES];
    [pickerView selectRow:[minArray indexOfObject:selectedMin] inComponent:1 animated:YES];
